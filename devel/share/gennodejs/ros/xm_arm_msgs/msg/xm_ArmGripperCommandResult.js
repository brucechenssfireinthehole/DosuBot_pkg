...
class xm_ArmGripperCommandResult {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new xm_ArmGripperCommandResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new xm_ArmGripperCommandResult(null);
...
module.exports = xm_ArmGripperCommandResult;
